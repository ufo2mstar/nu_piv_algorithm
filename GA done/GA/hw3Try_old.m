...
for m=minx:maxx
	for n=miny:maxy
		phi(m+1-minx,n+1-miny)=sum(dot(x1d(96:159,96:159),x2d(96+m:159+m,96+n:159+n)));
% 		phi(m,n)=sum(sum(dot(x1d(96:159,96:159),x1d(96:159,96:159))));
	end
end

sprintf('Correlation CPU time: %10.5f sec',toc(t)) 
figure(3)
...
for m=minx:maxx
	for n=miny:maxy
		mqd(m+1-minx,n+1-miny)=sum(sum((x1d(96:159,96:159)-x2d(96+m:159+m,96+n:159+n)).^2));
	end
end

sprintf('MqD CPU time: %10.5f sec',toc(t))
% figure(3)
